...
// import { Todo, TodoRecords } from "../../types/ApiSchema";
...
//   const WeeklyRecords: React.FC<TodoRecords> = () => {

//   const [allRecordData, setAllRecordData] = useState<TodoRecords[]>([]);
    


//   useEffect(() => {
//   ApiServices.getToDoListAll("all",(response: TodoRecords) => {
//     if (response.statusCode === 200) {
//       setAllRecordData(response?.data?.months);
//       // toast('nhghngn')
...
//                 >
//                   {allRecordData && allRecordData.map((todo:Todo, index:number) => {
//                     return (
//                       <>
